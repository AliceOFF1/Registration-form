...
8. FCL_08 (Ввод специальных символов в поле "Имя")
...
9. FCL_09 (Ввод больших значений в поле "Имя")
...
10. FCL_10 (Ввод цифр в поле "Имя")

- <span style="color: red;"> Результат </span>: Регистрация успешно завершена, несмотря на наличие цифр в поле "Имя".
